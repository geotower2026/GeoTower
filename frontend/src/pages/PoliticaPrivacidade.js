...
const PoliticaPrivacidade = () => (
  <div className="max-w-3xl mx-auto p-6 bg-white rounded shadow mt-8">
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">2. Dados Coletados</h2>
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">3. Finalidade do Tratamento dos Dados</h2>
    <ul className="list-disc ml-6 mb-2">
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">4. Base Legal (LGPD)</h2>
    <ul className="list-disc ml-6 mb-2">
    ...
    <p>Apesar dos esforços, nenhum sistema é totalmente imune a riscos, e o usuário também é responsável pela proteção de suas credenciais.</p>
    <h2 className="text-xl font-bold mt-6 mb-2">7. Cookies e Tecnologias de Sessão</h2>
    <p>A plataforma pode utilizar cookies e tecnologias similares para manter usuários autenticados, melhorar a experiência de navegação e garantir segurança durante o uso. O usuário pode desativar cookies no navegador, podendo afetar algumas funcionalidades.</p>
    <h2 className="text-xl font-bold mt-6 mb-2">8. Direitos do Titular dos Dados</h2>
    <ul className="list-disc ml-6 mb-2">
    ...
    <h2 className="text-xl font-bold mt-6 mb-2">9. Privacidade no Aplicativo Mobile</h2>
    <p>O aplicativo não acessa contatos pessoais, fotos ou arquivos do dispositivo sem autorização explícita. O uso das informações segue os mesmos princípios desta Política.</p>
    <h2 className="text-xl font-bold mt-6 mb-2">10. Retenção dos Dados</h2>
    <p>Os dados serão armazenados apenas pelo período necessário para cumprimento das finalidades operacionais, obrigações legais e auditorias, segurança e integridade do sistema.</p>
