            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2 text-sm font-bold text-slate-200">
                <div className="w-7 h-7 rounded-lg bg-indigo-500/20 flex items-center justify-center">
                  <FiFilter size={14} className="text-indigo-400" />
                </div>
                Filtros de Pesquisa
              </div>
              <button
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-3 py-2.5 text-sm rounded-xl border border-white/[0.09] bg-white/[0.06] text-slate-100 focus:border-indigo-400/60 focus:bg-white/[0.09] focus:outline-none focus:ring-2 focus:ring-indigo-500/20 transition"
                />
              </div>
              {/* Data fim */}
              <div className="relative">
